	...
	*/
	...
	protected function verify_files()
	{
		...
		if (file_exists(DIR . '/includes/md5_sums_vbulletin.php'))
		{
			...
			$md5_sum_versions = array('vbulletin' => '4.1.9');
			...
			if ($md5_sum_versions[$md5_sum_softwareid] != $endversion)
			{
	...
	protected function verify_install_environment()
	{
		if (defined('SKIPDB'))
		{
			...
			if(!$this->registry->config['Misc']['cookie_salt'])
				$this->startup_file_errors[] = 'Please input <b>$config[\'Misc\'][\'cookie_salt\']</b> with a random value into <b>config.php</b> (on line 106)<br />- Example (do not copy):<br /><b>$config[\'Misc\'][\'cookie_salt\'] = \'D74hdf$%^\';</b>';
