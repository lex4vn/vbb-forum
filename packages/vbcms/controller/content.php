...
//		$view->item_class = vB_Types::instance()->getTypeKey($this->package, $this->class);
	...
	protected function registerXHTMLTemplater()
	{
		...
		if (vB::$vbulletin->userinfo['styleid'] == vB::$vbulletin->options['mobilestyleid_advanced']
			OR vB::$vbulletin->userinfo['styleid'] == vB::$vbulletin->options['mobilestyleid_basic'])
		{
			$styleid = vB::$vbulletin->userinfo['styleid'];
		}
		global $bootstrap;
