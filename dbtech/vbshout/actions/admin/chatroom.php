...
if ($_REQUEST['action'] == 'modify')
{
	...
	print_select_row($vbphrase['dbtech_vbshout_instance'], 	'chatroom[instanceid]', $instances,	$chatroom['displayorder']);
...
if ($_POST['action'] == 'update')
{
	...
	// init data manager
	$dm =& VBSHOUT::datamanager_init('Chatroom', $vbulletin, ERRTYPE_CP);
