...
while ($activeusers_r = $db->fetch_array($activeusers_q))
{
	...
	$permarray = array(
		'permissions_parsed' 		=> VBSHOUT::load_instance_permissions($instance, $reportuser),
		'bbcodepermissions_parsed' 	=> VBSHOUT::load_instance_bbcodepermissions($instance, $reportuser)
	);
