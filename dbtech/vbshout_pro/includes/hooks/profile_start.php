...
if ($_REQUEST['do'] == 'dbtech_vbshout_options')
{
	// draw cp nav bar
	construct_usercp_nav('dbtech_vbshout_options');
	...
	if (intval($vbulletin->versionnumber) == 3)
	{
		...
		$templatename = 'dbtech_vbshout_options';		
	}
	else
	{
...
// ############################### start save options ##################################
if ($_POST['do'] == 'dbtech_vbshout_updateoptions')
{
...
// ############################### start display options ###############################
if ($_REQUEST['do'] == 'dbtech_vbshout_ignorelist')
{
	// draw cp nav bar
	construct_usercp_nav('dbtech_vbshout_ignorelist');
	...
	if (intval($vbulletin->versionnumber) == 3)
	{
		...
		$templatename = 'dbtech_vbshout_ignorelist';		
	}
	else
	{
		// Include the page template
...
// ############################### start save options ##################################
if ($_POST['do'] == 'dbtech_vbshout_updateignorelist')
{
	$vbulletin->input->clean_array_gpc('p', array(
	...
	if (count($SQL))
	{
		$db->query_write("
			...
			WHERE ignoreuserid = " . implode(',', $SQL) . "
...
// ############################### start display options ###############################
if ($_REQUEST['do'] == 'dbtech_vbshout_customcommands')
{
	// draw cp nav bar
	construct_usercp_nav('dbtech_vbshout_customcommands');
	...
	if (intval($vbulletin->versionnumber) == 3)
	{
		...
		$templatename = 'dbtech_vbshout_customcommands';		
	}
	else
	{
		// Include the page template
...
// ############################### start save options ##################################
if ($_POST['do'] == 'dbtech_vbshout_updatecustomcommands')
{
	$vbulletin->input->clean_array_gpc('p', array(
		'command' 		=> TYPE_ARRAY,
