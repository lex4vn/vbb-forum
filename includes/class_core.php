...
define('FILE_VERSION', '4.1.9'); // this should match installsteps.php
define('SIMPLE_VERSION', '419'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 56358 $
* @date		$Date: 2011-12-08 10:52:43 -0800 (Thu, 08 Dec 2011) $
*/
class vB_Database
{
	/**
