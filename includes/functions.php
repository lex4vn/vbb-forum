...
/**
* Stop execution at any point and print a trace.
* This will simply return if not in debug mode.
* If passed a variable, it will also output the contents.
*/
function vbstop($var = false)
{
	global $vbulletin;
	if (!$vbulletin->debug)
	{
		return; // Just return if not debug
	}
