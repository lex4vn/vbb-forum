...
class vB_Bootstrap
{
	...
	*/
	public function load_show_variables()
	{
		...
		It is planned to do a proper check of calendar permissions, and only show the link as appropriate, in the next update.
		*/
	...
	*/
	protected function fetch_style_record($force_styleid = 0)
	{
		...
		if ($force_styleid AND !$mobile_browser)
		{
			...
			AND ($vbulletin->userinfo['styleid'] == $vbulletin->options['mobilestyleid_advanced']
			OR $vbulletin->userinfo['styleid'] == $vbulletin->options['mobilestyleid_basic'])
		)
		{
