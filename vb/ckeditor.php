...
class vB_Ckeditor extends CKEditor
{
	...
	public function editor($id, $value = "", $config = array(), $events = array())
	{
		...
		if (!$this->textareaAttributes['autocomplete'])
		{
			$this->textareaAttributes['autocomplete'] = 'off';
		}
		...
		$out .= "
			<textarea id=\"{$id}_editor_backup\" name=\"message_backup\" class=\"hidden\"></textarea>
